        ...
        <div class="wz-form">
          ...
          <fieldset class="wz-group" data-group="required">
            ...
            <label class="wz-field" data-req="race"><span class="wz-label"><span class="wz-req-mark" aria-hidden="true">*</span> Race</span>
              <span class="wz-help">Determines your body slot — Forged races equip a docent, everyone else body armor — and excludes gear the wiki locks to a different race.</span>

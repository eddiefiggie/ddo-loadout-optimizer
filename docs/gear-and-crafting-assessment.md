...
| **Lamordia** | "Viktranium Experiment" content (a **Level 8+** system — *not* U81) | **Viktranium Experiment Crafting** | affix choice-slot, **two-keyed `(slot type × item category)`** | Viktranium ritual station | ✅ **DONE** — solver-active (194 options, 43 hosts). |
